...
public class LockIndicator extends View {
	...
	public void init(){
		...
		patternNoraml = new BitmapDrawable(GestureUtil.getInstance().getBitmap(context, GestureUtil.Node_Normal_type));
		patternPressed = new BitmapDrawable(GestureUtil.getInstance().getBitmap(context, GestureUtil.Node_Pressed_type));
